...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            #for문 돌면서  CrossAttnDownBlock2D CrossAttnDownBlock2D CrossAttnDownBlock2D  DownBlock2D 이거생성
        ...
        # mid
        if mid_block_type == "UNetMidBlock2DCrossAttn": #idm-vton에서는 이거사용, 이거 transformer후 residual통해서 결과출력
